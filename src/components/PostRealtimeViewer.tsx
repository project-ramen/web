    ...
    <div className="mt-4">
      <div className="flex items-stretch gap-0">
        ...
        <article ref={contentArticleRef} className={`flow-root ${viewerContentProse}`}>
          {content ? (
            <ReactMarkdown remarkPlugins={[remarkGfm, [remarkWikilinks, { resolve: resolveWikilink }]]} rehypePlugins={[rehypeRaw, rehypeSlug, rehypeHighlight]} components={markdownComponents}>{content}</ReactMarkdown>
          ) : (
